...
- 🎨 **هوية DLoF البصرية الأصلية**: العارض والمشغّل يستخدمان نفس ألوان وشعار تطبيق DLoF الرسمي (أخضر "Copper" وذهبي "Moss")، مع دعم تلقائي للوضع الليلي، وقائمة "الملفات" بنفس تصميم شاشة "ملفاتي" في التطبيق (بطاقة لكل ملف بأيقونة ولون حسب النوع، شارة المجال، حجم الملف، وبحث فوري).
...
src/
  ...
  viewer/             عارض HTML لمستند/حزمة واحدة + الهوية البصرية (brand.ts: ألوان، شعار، تسميات المجالات، أيقونات الملفات)
